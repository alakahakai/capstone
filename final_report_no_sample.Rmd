...
saveRDS(tdm, file = "data/tdm.RDS")
saveRDS(tdm2, file = "data/tdm2.RDS")
saveRDS(tdm3, file = "data/tdm3.RDS")
```
...
saveRDS(freqDF, file = "data/unigram.RDS")
saveRDS(freqDF2, file = "data/bigram.RDS")
saveRDS(freqDF3, file = "data/trigram.RDS")
```
